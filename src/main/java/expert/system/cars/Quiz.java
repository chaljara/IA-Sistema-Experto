...
public class Quiz {
	...
	public Quiz() {
		...
		questions.add(new Question("18. You often let other people influence your actions" , 0));
		questions.add(new Question("19. Your dreams do not tend to focus on the real world and its events" , 0));
		...
		questions.add(new Question("22. You are not a reserved and quiet person" , 0));
