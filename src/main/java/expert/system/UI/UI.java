...
private void showResultOnWindow(){
		...
		lblNewLabel.setIcon(new ImageIcon("res\\"+infoResult.getCarSelected().getId()+".jpg"));//..getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT));
